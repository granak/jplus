...
if (typeof JPlus.PlanContextMenuController == 'undefined') {
    JPlus.PlanContextMenuController = {};
    JPlus.PlanContextMenuController.extended = false;   // prevent Maximum call stack size exeeded error
}

$(document).on('jplus-backlog-is-loaded', function () {
    if (!JPlus.PlanContextMenuController.extended) {
        ...
        JPlus.PlanContextMenuController.extended = true;
    }
